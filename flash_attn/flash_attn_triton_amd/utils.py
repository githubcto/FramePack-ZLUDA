...
@functools.cache
def is_rdna():
    return is_hip() and get_arch() in ("gfx1030", "gfx1031", "gfx1032", "gfx1035", "gfx1036", "gfx1100", "gfx1101", "gfx1102", "gfx1103", "gfx1151", "gfx1200", "gfx1201")

@functools.cache
def arch_supports_fp8():
    return is_hip() and get_arch() in ('gfx942', "gfx1200", "gfx1201")
